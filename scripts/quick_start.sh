...
# Quick Start Script for Brick Auth Service
# Build, run, and test the API by default
# Usage: ./scripts/quick_start.sh [action] [version] or ./scripts/quick_start.sh [version]
...
echo "🚀 Brick Auth Quick Start Script"
echo "===================================="
